members_dict = {
    'appointment_management_sup_agent': 
        'Specialized agent responsible for managing appointments: create appointment, get appointment, update or cancel appointment.',
    
    'check_suggest_availability_sup_agent': 
        'Specialized agent that checks the availability of a doctor and suggests 3 possible meeting dates.',
    
    'faq_sup_agent': 
        'Specialized agent to answer general questions about hospital services, doctors, departments or procedures.',
    
    'patient_management_sup_agent': 
        'Specialized agent responsible for patient operations: create patient if new, get patient if exists, update patient info.'
}
